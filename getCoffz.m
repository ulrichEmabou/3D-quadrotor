function [coffz, A, b] = getCoffz(waypoints)
...
b=[waypoints(3,1) waypoints(3,2) waypoints(3,3) waypoints(3,4) waypoints(3,2) waypoints(3,3) waypoints(3,4) waypoints(3,5) zeros(1,24)];

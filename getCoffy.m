function [coffy, A, b] = getCoffy(waypoints)
...
b=[waypoints(2,1) waypoints(2,2) waypoints(2,3) waypoints(2,4) waypoints(2,2) waypoints(2,3) waypoints(2,4) waypoints(2,5) zeros(1,24)];
